...
st.markdown("Please enter the transaction details and use the predict button to check if the transaction is fraudulent.")
...
if st.button("Predict"):
    ...
    st.subheader(f"Prediction Result:'{int(prediction)}'")  # 1 for Fraud, 0 for Legitimate
    if prediction == 1:
